...
var (
	filter_Sms_SendSMS_0 = &utilities.DoubleArray{Encoding: map[string]int{"phone_number": 0, "content": 1}, Base: []int{1, 1, 2, 0, 0}, Check: []int{0, 1, 1, 2, 3}}
)

func request_Sms_SendSMS_0(ctx context.Context, marshaler runtime.Marshaler, client SmsClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.URL.Query(), filter_Sms_SendSMS_0); err != nil {
...
func RegisterSmsHandlerClient(ctx context.Context, mux *runtime.ServeMux, client SmsClient) error {
	...
	mux.Handle("GET", pattern_Sms_SendSMS_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Sms_SendSMS_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_Sms_SendSMS_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_Sms_SendSMS_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"v1", "security", "sms", "send", "phone_number", "content"}, ""))
)

var (
	forward_Sms_SendSMS_0 = runtime.ForwardResponseMessage
)
